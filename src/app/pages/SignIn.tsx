...
export default function SignIn() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Simulate Google login - will be implemented with proper Firebase setup
      await new Promise(resolve => setTimeout(resolve, 1500));
      alert('🚀 Google Sign In is coming soon!\n\nFor now, please use OTP login.');
    } catch (error: any) {
              ...
              {lStep === 1 ? (
                <div id="ls1">
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '20px 0' }}>
                    ...
                    <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Or</span>
                    <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255,255,255,0.2)' }}></div>
                  </div>
                  ...
                  <button 
                    ...
                    style={{
                      width: '100%',
                      padding: '12px',
                      backgroundColor: googleLoading ? '#f0f0f0' : '#fff',
                      color: '#0c0c0c',
                      border: 'none',
                      borderRadius: '6px',
                      fontSize: '14px',
                    ...
                    onMouseOver={(e) => !googleLoading && (e.currentTarget.style.backgroundColor = '#f5f5f5')}
